...
export function AnalyticsScripts() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("fundamental-cookie-consent", handleConsent);
    return () => window.removeEventListener("fundamental-cookie-consent", handleConsent);
  }, []);
    ...
    <>
      {googleTagId ? (
        <>
          ...
          <Script id="fundamental-google-tag" strategy="afterInteractive">
            {`
      ...
      {metaPixelId ? (
        <Script id="fundamental-meta-pixel" strategy="afterInteractive">
          {`
